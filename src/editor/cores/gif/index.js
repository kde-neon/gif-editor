...
//! Image move and rotate library
// import { fabric } from 'fabric';
// let canva = new fabric(that.canvas)
// let fb = new fabric.rect({
//   width: 400,
//   height: 400,
//   fill: 'red',
//   position: 'fixed'
...
export default class Gif extends EventEmitter {
  ...
  create() {
    ...
    that.canvas.id = "MainCanvas"
    that.ctx = that.canvas.getContext('2d')
    that.layer = document.createElement('canvas')
    that.layerctx = that.layer.getContext('2d')
