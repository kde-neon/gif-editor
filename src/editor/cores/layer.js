...
export default class Layer extends ElementController {
  ...
  create() {
    ...
    //! TODO
    // File resize
    // that.layerCanv = document.createElement('canvas')
    // that.layrctx = that.layerCanv.getContext('2d')


    // const fileDom = document.getElementById("image-input");
    // fileDom.onchange = () => {
    //   let canva = new fabric.Canvas(this.mainCtx, {
    //     isDrawingMode: true
    //   })
    ...
    // that.mainCtx.lineWidth = "6";
    // that.mainCtx.fillStyle = "red";
    // that.mainCtx.rect(5, 5, 290, 140);
    // that.mainCtx.fill();
